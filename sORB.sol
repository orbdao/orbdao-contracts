...
contract sOrbToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Orb", "sORB", 9) ERC20Permit() {
    ...
    /**
        @notice increases sORB supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sORB
